@frozen public struct Magic4: RawRepresentable {
...
extension Magic4: Equatable {
    public static func == (lhs: Magic4, rhs: Magic4) -> Bool {
        return lhs.rawValue == rhs.rawValue
    }
}

extension Magic4: Hashable {
...
extension Magic4: CustomStringConvertible {
    @inlinable public var description: String {
        return stringValue.debugDescription
    }
}

extension Magic4: CustomDebugStringConvertible {
...
extension Magic4: ExpressibleByStringLiteral {
...
extension Magic4: ExpressibleByArrayLiteral {
...
extension Magic4: ByteEncoder {
    @inlinable public static func encode<W: ByteWriter>(_ value: Magic4, to writer: inout W) throws {
